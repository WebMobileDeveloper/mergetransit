...
class CurrentCustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $details=$details->select('details.*', 'drivers.user_id', 'drivers.employee_id')->where('details.del_date', '>=',$today);
        ...
        return view('admin.currentcustomers.index', compact('details','s'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.currentcustomers.detailEdit', compact('drivers','detail','contacts','detail_origin','detail_dest'));
    }
