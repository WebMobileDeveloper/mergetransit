...
class ContactController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sadmin.contactlist.index',compact('contactlist','s'));
    }
    /**
    ...
    {
        return view('sadmin.contactlist.contactlistAdd');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (count($checkfield)>0) {
            ...
            $contact->save();
            return redirect('sadmin/contactlist');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('sadmin.contactlist.contactlistEdit',compact('contact'));
    }
