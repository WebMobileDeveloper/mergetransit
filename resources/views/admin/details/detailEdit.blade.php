        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" id="user_form" name="user_form" action="{{url('admin/details/'.$detail->id )}}" method = "post" enctype="multipart/form-data">
                            ...
                            <div class="shipper_area">
                                ...
                                @foreach($detail_origin as $origin_item)
                                    <div class="form-group custom_input shipper" >
                                        ...
                                        ?>
                                        <div class="col-xs-1 " style="padding-left:0;padding-right:10px">
                                            <input class="form-control origin_city locality neighborhood" name="origin_city[]"  type="text" value="{{$oriArr[0]}}" placeholder="City" required />
                                        </div>
                            ...
                            <div class="consignee_area">
                                ...
                                @foreach($detail_dest as $dest_item)
                                    ...
                                    <div class="form-group custom_input consignee">
                                        ...
                                        ?>
                                        <div class="col-xs-1 " style="padding-left:0;padding-right:10px">
                                            <input class="form-control destination_city locality neighborhood" name="destination_city[]" type="text" value="{{$desArr[0]}}" placeholder="City"  required/>
                                        </div>
                                        <div class="col-xs-1 " style="padding-left:10px;padding-right:0">
