                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group custom_input">
                                <label class="col-sm-2 control-label">Assign Employee<span class="required"></span></label>
                                 <div class="col-xs-4">
                                 <select class="form-control select2" multiple="multiple" name="employee[]" id="employee" data-placeholder="Select a State" style="width: 100%;">
                                        <?php 
                                        $em_arr = explode(',',$driver[0]->employee_id);
                                        ?>
                                        @foreach ($employees as $employee)
                                            
                                            <option {{(in_array($employee->id, $em_arr))?"selected":""}} value= {{$employee->id}}>{{$employee->firstname}} {{$employee->lastname}} </option>
