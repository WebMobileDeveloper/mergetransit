        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" id="role_form" name="role_form" action="{{url('admin/roles/'.$role->id )}}" method = "post">
                        ...
                        <div class="box-body">
                            <div class="form-group custom_input">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" name="title" type="text" value="{{ $role->title }}" placeholder="Title" required>
                                </div>
                            </div>
                            <div class="form-group custom_input">
                                <label class="col-sm-2 control-label">Description<span class="required"></span></label>
                                 <div class="col-xs-4">
                                    <input class="form-control" name="desc" type="text" value="{{ $role->description }}" placeholder="Description" required>
                                </div>
                            </div>
