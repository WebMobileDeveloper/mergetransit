        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" id="user_form" name="user_form" action="{{url('sadmin/currentcustomer/'.$detail->id )}}" method = "post" enctype="multipart/form-data">
                                        ...
                                        <p >
                                            ...
                                            @for($i=0;$i<count($name_arr);$i++)
                                                <label class="file_label label-success file_index_{{$i}}" >
                                                    {{$name_arr[$i]}}
                                                    <a onclick="delete_file('{{$detail->id }}','{{$i}}')" data-href="{{url('sadmin/delete_file/'.$i)}}" class="close_a">x</a>
                                                </label>	
                                            @endfor		                
                                        </p>
                                        @endif
