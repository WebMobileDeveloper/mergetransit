...
<script>
    ...
    function delete_detail(id) {
        ...
        {
            var url = "{{ url('sadmin/details/delete') }}";
            ...
            <div class="col-xs-12">               
                ...
                <div class="box account_list">
                    ...
                    <div class="box-header with-border">
                        <a href="{{url('/sadmin/details/create')}}" class="btn btn-info ">Add New</a>
                        <div class="text-right">
                            <form action="{{url('/sadmin/details')}}" method="get" class="form-inline">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($details as $tr)
                                                ...
                                                <tr class="gradeA odd" item_id="<?php echo $tr->id ?>">
                                                    ...
                                                    <td class="center ">
                                                        <a onclick="addexpense({{$tr->id}})" class="btn btn-primary btn-xs edit"><i class="fa fa-edit "></i> Expense</a>  
