        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" id="role_form" name="role_form" action="{{url('/sadmin/details')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="box-body">
                            ...
                            <div class="shipper_area">
                                <div class="form-group custom_input shipper" >
                                    ...
                                    <div class="col-xs-1 " style="padding-left:0;padding-right:10px">
                                        <input class="form-control origin_city locality" name="origin_city[]" type="text" value="" placeholder="City" required />
                                    </div>
                            ...
                            <div class="consignee_area">
                                <div class="form-group custom_input consignee">
                                    ...
                                    <div class="col-xs-1 " style="padding-left:0;padding-right:10px">
                                        <input class="form-control destination_city locality" name="destination_city[]" type="text" value="" placeholder="City" required />
                                    </div>
                                    <div class="col-xs-1 " style="padding-left:10px;padding-right:0">
