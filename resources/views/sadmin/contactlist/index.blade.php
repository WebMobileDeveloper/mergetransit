...
<script>
   function edit_item(obj) {
       ...
       var url = "{{ url('sadmin/contactlist') }}";
   ...
   function delete_item(obj) {
        ...
        if(confirm("Are you sure to delete this Company info ?")) {
            var url = "{{ url('sadmin/contactlist/delete') }}";
            ...
            <div class="col-xs-12">               
                ...
                <div class="box account_list">
                    ...
                    <div class="box-header with-border">
                        <a href="{{url('/sadmin/contactlist/create')}}" class="btn btn-info ">Add New</a>
                        <div class="text-right">
                            <form action="{{url('/sadmin/contactlist')}}" method="get" class="form-inline">
