<?php
	...
	echo '<div class="module-32 module' . ( $style ? ' has-background' : '' ) . '"' . $hash . $style . '>';
			...
			echo '<article class="post-article">';
				...
				get_template_parts (
					...
					array (
						...
						'templates/modules/32/header',
						
						'templates/modules/32/thumbnail',
						
						'templates/modules/32/content'
